...
with st.sidebar:
    ...
    if st.session_state.demo_mode:
        ...
        st.info(
            "Demo Mode is ON. "
            "Use AI Recovery to demonstrate the workflow."
        )
...
if st.session_state.demo_mode:
    ...
    <div class="demo-box">
        ...
        <p>
        Demonstrate how RecoverAI identifies a failed payment,
        analyzes recovery probability, generates an AI strategy,
        attempts recovery and records the result.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
# =========================================================
    ...
    if failed_data.empty:
        ...
        journey_col1, journey_col2, journey_col3, journey_col4 = (
            st.columns(4)
        )
        ...
        with journey_col3:
            ...
            if is_attempted:
                ...
                status_icon = "🟢"
                status_text = "Recovery attempted"

            else:

                status_icon = "🟡"
                status_text = "Ready to attempt"
        ...
        with journey_col4:
            ...
            if is_recovered:
                ...
                status_icon = "🟢"
                status_text = "Payment recovered"

            else:

                status_icon = "⚪"
                status_text = "Awaiting recovery"
        ...
        if is_recovered:
            ...
            progress_value = 1.0
            progress_text = "100% — Payment Recovered"

        elif is_attempted:

            progress_value = 0.66
            progress_text = "66% — Recovery Attempted"

        else:

            progress_value = 0.33
            progress_text = "33% — Ready for Recovery"
        ...
        st.write(
            ...
            "recovery probability and priority to recommend "
            "the best business action."
        )
        ...
        if is_recovered:
            ...
            st.info(
                "The payment is ready for recovery."
            )
